...
function loadFiltersFromURL() {
    ...
    } else if (specialParam && (specialParam === 'ghibli' || specialParam === 'conan')) {
...
function resetMetaTags() {
    ...
    const defaultDescription = '日本で視聴できないNetflix作品を国別に検索できるツール。NordVPNとuNoGSで視聴可能な36ヵ国の作品情報を提供しています。';
    const defaultUrl = IS_GITHUB_PAGES 
